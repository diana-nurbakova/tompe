...
def generate_report(data: dict) -> str:
    ...
    w()
    w("12 published studies were used in this sensitivity run (Temnikova 2010 excluded).")
    ...
    w("- **Language pairs covered:** EN\u2013NL, EN\u2013JA, EN\u2013DE, EN\u2013SR, EN\u2013FR, EN\u2013PT-BR, EN\u2013FI, EN\u2013EL, AR, RU, ES, BG")
    ...
    w("| F4b | `F4b_difficulty_combined.png` | Combined scatter: all sources on one axis, min-max normalised difficulty |")
    ...
    w("  exp1_difficulty_ordering.py         # 3 extractors (Daems/Yamada/Popovic)")
